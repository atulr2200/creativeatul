...
"""
#from material.admin.base import SomeMaterialAdminClass
...
DATABASES = {
    'default': {
        ...
        'USER': 'root',
        'PASSWORD': 'atul@123',
        'HOST': 'localhost',  # or the hostname or IP address of your MySQL server
        'PORT': '3306',           # Leave this empty for the default MySQL port (3306)
    }
}
